...
def new_load(network:GraphModel, container:cim.EquipmentContainer, name:str, 
                node:str|cim.ConnectivityNode, p:float = 0,  q:float = 0,  customerCount:float = 1, grounded:float = 1, phaseConnection:str) -> None:
    ...
    load.p = p
    load.q = q
    load.customerCount = customerCount
    load.grounded = grounded
    load.phaseConnection = phaseConnection
