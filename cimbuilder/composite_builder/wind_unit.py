"""Build a wind generation unit (PowerElectronicsConnection + PowerElectronicsWindUnit)."""
...
from cimbuilder.object_builder.inverter.new_wind_unit import new_wind_unit as _new_wind_unit
...
def new_wind_unit(
    ...
    *,
    ...
    """Create a wind unit: PowerElectronicsConnection + PowerElectronicsWindUnit.
    ...
    Args:
        ...
        max_p_kW:           Maximum active power output, kW.
