"""Build a behind-the-meter PV inverter (PowerElectronicsConnection + PhotoVoltaicUnit)."""
...
def new_btm_pv_unit(
    ...
    *,
    ...
    """Create a BTM PV unit: PowerElectronicsConnection + PhotoVoltaicUnit.

    Behind-the-meter PV is modelled as a single-terminal inverter whose
    ``p`` represents the aggregate AC injection at the metering point.
